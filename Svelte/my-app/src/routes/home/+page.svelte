<script lang="ts">
    ...
    let allRequestData: any[] = data.props.requestsAll ? data.props.requestsAll : [];
    let allOccupiedPorts: any[] = data.props.usedPorts ? data.props.usedPorts : [];
                                                                                ...
                                                                                <div class="flex items-center space-x-3">
                                                                                    <div class="avatar">
                                                                                        <div class="mask mask-squircle w-12 h-12">
                                                                                            <img src="/assets/makes/{key}.svg" alt="{key} logo"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div>{car.model}</div>
                                                                                </div>
