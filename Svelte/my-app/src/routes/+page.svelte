            ...
            <div class="card-body">
              ...
              <span class="label-text-alt">
                  <a href="/register" class="link link-hover">Register</a>
                    ...
                    <span class="label-text-alt"><a href="/forgotpassword"
                                                    class="link link-hover">Forgot Password</a></span>
                </div>
                <div class="divider -mt-0.5">OR</div>
                <button class="btn btn-neutral w-full"
                        style="display: flex; align-items: center; justify-content: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 63 63"
