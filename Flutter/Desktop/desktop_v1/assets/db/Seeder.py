...
def generate_charging_ports_data(num_entries):
    ...
    for i in range(num_entries):
        ...
        charging_speed = 0 if status == "Out of order" else random.randint(1, 100)
...
mail_servers = ["clintonemail", "BidenCrimeFamily", "ClintonCrimeFamily","whitehouse","bald"]
domains = ["gov", "net", "org", "com","us"]
names = ["Joe Rogan", "Donald Trump", "Joseph Biden", "Klaus Schwab", "Bingus","Xi Jinping","Mark Rutte","Quadringus","Jeff Bezos"]
